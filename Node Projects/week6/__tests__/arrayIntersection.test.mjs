const { intersection_of_arrays, intersection_of_n_arrays } = require("../arrayIntersection.mjs");
...
test("intersection_of_arrays with numbers", () => {
    ...
    expect(intersection_of_arrays([3, 4, 5, 6], [3, 4])).toEqual([3, 4]);
});
...
test("intersection_of_n_arrays with numbers", () => {
    expect(intersection_of_n_arrays([3, 4, 5, 6], [3, 4])).toEqual([3, 4]);
    expect(intersection_of_n_arrays([1,2,3,4,5], [6, 5, 4, 3], [3, 4], [3,4,5])).toEqual([3,4]);
});
